...
func TestValidate_Rejects(t *testing.T) {
	...
	tests := []struct {
		...
		{"negative HotThreshold", func(c *Config) { c.HotThreshold = -0.01 }},
		{"HotThreshold above 1", func(c *Config) { c.HotThreshold = 1.01 }},
		{"HotThreshold equal to ColdThreshold", func(c *Config) { c.HotThreshold = c.ColdThreshold }},
		{"HotThreshold below ColdThreshold", func(c *Config) { c.HotThreshold = c.ColdThreshold - 0.01 }},
